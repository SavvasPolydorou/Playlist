...
public class PlayListDemo {
    ...
    public static void main(String[] arg) {
        ...
        playlist.addSong( new Song("Rock it", 150,"Rockstar") );    
        ...
        System.out.println();
        System.out.println("Searching a song by title");
        System.out.println(playlist.searchSongByTitle("Bad"));
        
        System.out.println();
        System.out.println("Listing songs that contain the word \"it\"");
        playlist.searchSongThatContains("it");
